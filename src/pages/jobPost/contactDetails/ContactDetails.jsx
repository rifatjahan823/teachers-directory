                    ...
                    <div className="col-lg-8">
                        <div className="account-container">
                            ...
                            <div className='contact-condition'>
                                ...
                                <ul className="li_style text-justify fs-3">
                                <li>
                                 <span>
                                 You have read and accept our <span><a href="#">terms and conditions.</a></span>
                                 </span>
                                </li>
                                <li>
                                <span>
                                You acknowledge and take responsibility for the contents and accuracy
                                of this advert. 
                                </span>
                                </li>
                                </ul>
